...
- **Tidy top bar.** On phones the header collapses into a burger menu holding Now Showing, your connection status, the sign-in link, and the version, leaving just the logo and one button up top.
